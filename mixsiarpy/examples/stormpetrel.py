"""Storm-petrel example with raw sources and a Region fixed effect.
...
MIX_FILENAME = DATA_DIR / 'stormpetrel_consumer.csv'
SOURCE_FILENAME = DATA_DIR / 'stormpetrel_sources.csv'
DISCR_FILENAME = DATA_DIR / 'stormpetrel_discrimination.csv'

# Results are saved relative to the current Spyder/terminal working directory.
OUTPUT_DIR = Path("outputs/stormpetrel")
...
print(
    f"stormpetrel: model built ({mix['N']} mixtures, "
