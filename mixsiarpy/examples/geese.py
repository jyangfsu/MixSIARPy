"""Geese example with concentration dependence and a Group fixed effect.
...
MIX_FILENAME = DATA_DIR / 'geese_consumer.csv'
SOURCE_FILENAME = DATA_DIR / 'geese_sources.csv'
DISCR_FILENAME = DATA_DIR / 'geese_discrimination.csv'

# Results are saved relative to the current Spyder/terminal working directory.
OUTPUT_DIR = Path("outputs/geese")
...
print(
    f"geese: model built ({mix['N']} mixtures, "
