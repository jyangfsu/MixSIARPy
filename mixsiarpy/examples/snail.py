"""One-tracer example with raw source observations.
...
MIX_FILENAME = DATA_DIR / 'snail_consumer.csv'
SOURCE_FILENAME = DATA_DIR / 'snail_sources.csv'
DISCR_FILENAME = DATA_DIR / 'snail_discrimination.csv'

# Results are saved relative to the current Spyder/terminal working directory.
OUTPUT_DIR = Path("outputs/snail")
...
print(
    f"snail: model built ({mix['N']} mixtures, "
