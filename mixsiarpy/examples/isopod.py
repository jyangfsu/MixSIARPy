"""Isopod fatty-acid example with a Site random effect.
...
MIX_FILENAME = DATA_DIR / 'isopod_consumer.csv'
SOURCE_FILENAME = DATA_DIR / 'isopod_sources.csv'
DISCR_FILENAME = DATA_DIR / 'isopod_discrimination.csv'

# Results are saved relative to the current Spyder/terminal working directory.
OUTPUT_DIR = Path("outputs/isopod")
...
mix = load_mix_data(
    ...
    iso_names=['c16.4w3', 'c18.2w6', 'c18.3w3', 'c18.4w3', 'c20.4w6', 'c20.5w3', 'c22.5w3', 'c22.6w3'],
    factors=['Site'],
    fac_random=[True],
    fac_nested=[False],
    cont_effects=None,
...
print(
    f"isopod: model built ({mix['N']} mixtures, "
