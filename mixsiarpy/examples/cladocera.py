"""Cladocera fatty-acid example with individual fixed effects.
...
MIX_FILENAME = DATA_DIR / 'cladocera_consumer.csv'
SOURCE_FILENAME = DATA_DIR / 'cladocera_sources.csv'
DISCR_FILENAME = DATA_DIR / 'cladocera_discrimination.csv'

# Results are saved relative to the current Spyder/terminal working directory.
OUTPUT_DIR = Path("outputs/cladocera")
...
mix = load_mix_data(
    ...
    iso_names=['c14.0', 'c16.0', 'c16.1w9', 'c16.1w7', 'c16.2w4', 'c16.3w3', 'c16.4w3', 'c17.0', 'c18.0', 'c18.1w9', 'c18.1w7', 'c18.2w6', 'c18.3w6', 'c18.3w3', 'c18.4w3', 'c18.5w3', 'c20.0', 'c22.0', 'c20.4w6', 'c20.5w3', 'c22.6w3', 'BrFA'],
    factors=['id'],
    fac_random=[False],
    fac_nested=[False],
    cont_effects=None,
...
print(
    f"cladocera: model built ({mix['N']} mixtures, "
